...
export function LessonsPage() {
    ...
    async function carregarDados() {
        ...
        try {
            ...
            setError(
                "NÃ£o foi possÃ­vel carregar as aulas."
            );
    ...
    async function abrirSelecaoProfessor(
        ...
        try {
            ...
            const pessoas =
                await PeopleService.listar(igrejaId);
            ...
            setError(
                "NÃ£o foi possÃ­vel carregar os professores."
            );
    ...
    async function selecionarProfessor(
        ...
        try {
            ...
            setError(
                "NÃ£o foi possÃ­vel escalar o professor."
            );
        ...
        try {
            ...
            setError(
                error instanceof Error
                    ? error.message
                    : "NÃ£o foi possÃ­vel atualizar a aula."
            );
    ...
    async function handleSubmit(
        ...
        try {
            ...
            setError(
                error instanceof Error
                    ? error.message
                    : "NÃ£o foi possÃ­vel cadastrar a aula."
            );
    ...
    function podeVisualizarAula(
        ...
        if (
            ...
            // Encontra a prÃ³xima aula a partir de hoje
            const proximaAula =
                aulas
                    .filter(
                        (item) =>
            ...
            // Se nÃ£o houver mais aulas futuras,
                        ...
                        >
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    placeholder="Ex.: Doutrina das Ãšltimas Coisas"
                                    className="w-full rounded-lg border border-slate-300 px-3 py-2 outline-none transition focus:border-blue-500"
                                />
