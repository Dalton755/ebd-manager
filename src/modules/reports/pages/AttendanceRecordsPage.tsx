                                ...
                                (registro) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-start justify-between gap-3">
                                            ...
                                            <span className={
                                                registro.localizacao_status === "DENTRO"
                                                    ? "rounded-full bg-emerald-100 px-2.5 py-1 text-[11px] font-bold text-emerald-700"
                                                    : "rounded-full bg-red-100 px-2.5 py-1 text-[11px] font-bold text-red-700"
                                            }>
                                                {registro.localizacao_status}
                                            </span>
                                        ...
                                        <button
                                            ...
                                            className="mt-3 w-full rounded-xl bg-blue-600 px-3 py-2.5 text-sm font-bold text-white"
                                        >
                                            Ver localização
                                        </button>
