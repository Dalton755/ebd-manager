                                    ...
                                    >
                                        ...
                                        <div className="flex items-start justify-between gap-3">
                                            ...
                                            <div className="min-w-0">
                                                ...
                                                <code className="mt-1 inline-block rounded-md bg-slate-100 px-2 py-1 text-[11px] font-bold text-slate-600">
                                                    {recurso.codigo}
                                                </code>
                                            </div>
                                        ...
                                        <div className="mt-4 grid grid-cols-2 gap-2">
                                            ...
                                            <button
                                                ...
                                                className={
                                                    recurso.ativo
                                                        ? "rounded-xl border border-red-200 px-3 py-2.5 text-sm font-bold text-red-600"
                                                        : "rounded-xl border border-emerald-200 px-3 py-2.5 text-sm font-bold text-emerald-600"
                                                }
                                            >
