                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-start justify-between gap-3">
                                                ...
                                                <span
                                                    className={`inline-flex shrink-0 rounded-full px-2.5 py-1 text-[11px] font-bold ${obterClasseStatus(
                                                        assinatura.status
                                                    )}`}
                                                >
                                                    {assinatura.status}
                                            ...
                                            <div className="mt-3 grid grid-cols-2 gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 px-3 py-2.5 text-sm font-bold text-slate-700"
                                                >
                                                    <Edit3 size={16} />
                                                    Editar
                                                </button>
                                                ...
                                                <button
                                                    ...
                                                    className="inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-3 py-2.5 text-sm font-bold text-white"
                                                >
